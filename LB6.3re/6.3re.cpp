...
int FindMin(int* arr, int SIZE, int nMin, int i)
{
    if (i < SIZE)
    {
        ...
        return FindMin(arr, SIZE, nMin, ++i);
    }
    else
    {
        return nMin;
...
int SecondFindMin(T* arr, const int SIZE, int nMin, int i)
{
    if (i < SIZE)
    {
        ...
        return SecondFindMin(arr, SIZE, nMin, ++i);
    }
    else
    {
        return nMin; 
...
int main()
{
    ...
    cout << endl;
    cout << "Min = " << FindMin(arr, SIZE, arr[0], 0) << endl; 
    ...
    cout << endl;
    cout << "SecondMin = " << SecondFindMin(arr, SIZE, arr[0], 0) << endl;
